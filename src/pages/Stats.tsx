...
export function Stats() {
  ...
  const trendAxis = useMemo(() => axisLabels(keys, unit, chartW - AXIS_GUTTER), [keys, unit, chartW])
  const balAxis = useMemo(() => axisLabels(keys, unit, chartW - AXIS_GUTTER), [keys, unit, chartW])
  ...
  const trendOption = useMemo(() => {
    ...
    const shortOf = new Map(names.map((n, i) => [n, short[i]]))
    const legend = {
      data: names,
