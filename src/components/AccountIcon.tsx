...
//
// 配色方向按各家官方来，不能一律套成「品牌色底 + 白标」：
//   微信 / 支付宝的官方形象就是彩色底、白色标 → plate: 'brand'
//   中行 / 招行的官方形象是白底红标，反过来做会变成负片，认不出来 → plate: 'light'
