...
interface Brand {
  ...
  fg?: string
  /** 位图图标（官方图标裁圆）。有它时 path / viewBox 不用 */
  image?: string
...
const HUABEI: Brand = { color: '#1d7cf7', plate: 'brand', scale: 1, viewBox: '0 0 1 1', path: '', image: brandImg('huabei-v1.png'), imageLight: true }
  ...
  if (b.image) {
    return (
      <img
        ...
        style={{ width: size, height: size, boxShadow: b.imageLight ? 'inset 0 0 0 1px rgba(0,0,0,.09)' : undefined }}
      />
    )
  }
