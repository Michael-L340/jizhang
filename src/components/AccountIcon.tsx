...
// 所以同一个 scale 下渲染出来一样大。招商银行原路径在圆形主标记右边还挂着六条横杠
// （x 191~246，超出圆圈往右伸），会把重心带偏，已经裁掉，只留圆形主标记本身。
interface Props {
  name: string
  size?: number
}
...
const CMB: Brand = { bg: '#E50113', scale: 0.6, viewBox: '0.00 389.00 240.80 245.90', path: 'M119.8 389l-3.1 0.3-6.2 0.3-6.2 0.8-3.1 0.6-3.1 0.6-2.8 0.6-3.1 0.8-5.7 1.7-5.7 1.7-5.7 2.3-5.4 2.5-5.2 2.8-2.6 1.4-2.5 1.4-2.6 1.7-2.5 1.4-4.8 3.7-2.3 1.7-2.5 1.7-4.2 4-4.2 4.2-2.3 2-2 2.3-2 2-2 2.3-3.4 4.8-3.7 4.8-3.1 5.1-1.4 2.6-1.4 2.3-2.8 5.4-2.5 5.4-2 5.7-2 5.7-1.7 5.5-1.4 5.9-1.1 6.2-0.9 6.2-0.3 6.2L0 512v3.1l0.3 3.1 0.3 6.5 0.9 5.9 0.6 3.1 0.6 3.1 0.6 2.8 0.8 3.1 1.7 5.7 2 5.9 2 5.4 2.5 5.7 2.8 5.1 1.4 2.8 1.4 2.5 1.7 2.5 1.4 2.3 3.7 4.8 1.7 2.5 1.7 2.3 4 4.5 4.2 4.2 2 2 2.3 2 2 2 2.3 2 4.8 3.7 4.8 3.4 5.1 3.1 2.5 1.4 2.6 1.7 5.4 2.5 5.4 2.5 5.7 2.3 5.7 2 5.7 1.4 5.9 1.4 6.2 1.1 6.2 0.9 6.2 0.6h11.3l4.8-0.3 4.8-0.6 2.5-0.3 2.3-0.3 4.8-0.8 4.5-1.1 4.8-1.1 4.5-1.4 4.3-1.7 4.5-1.7 4.2-1.7 4.3-2 4.2-2.3 4-2.3 4-2.5 3.7-2.6 3.7-2.8 3.7-2.8 3.4-3.1 3.4-3.1 3.4-3.4 3.1-3.1 3.1-3.7 2.8-3.7 2.6-3.7 2.8-3.7 2.3-4 2.5-4.2 2-4 2-4.2 2-4.2 1.7-4.5h-17.2l2.6 5.9-26.6 38.7H52L23.5 563l62.8-162 35.5 85 33.9-85.7 32.5 76h52.6l-1.7-4.5-1.7-4.8-1.7-4.5-2.3-4.2-2-4.5-2.6-4.2-2.5-4-2.5-4-3.1-4-1.4-2-1.4-2-3.1-3.7-3.4-3.4-3.4-3.4-3.7-3.4-3.7-3.1-3.7-2.8-4-2.8-4-2.8-4.2-2.5-4.2-2.3-4.2-2.3-4.5-2-4.5-2-2.3-0.8-2.3-0.9-4.7-1.3-4.8-1.4-4.8-1.1-5.1-0.8-4.8-0.9-5.1-0.3-5.4-0.6h-8.2z m-7 172.7h68.1l-34.8-84.2-33.3 84.2z m-69.8 0h68.1l-34.8-84.2L43 561.7z' }
