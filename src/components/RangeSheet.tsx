    ...
    <>
      <Sheet open={open} onClose={onClose} title="时间范围">
        ...
        <div className="mt-4">
          ...
          <button
            type="button"
            className="w-full mt-3 py-2.5 rounded-xl bg-brand text-white text-sm font-medium"
            onClick={() => {
...
function Check() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" className="text-brand">
