...
| 文件 | 什么时候读 | 大小 |
|---|---|---|
| `CLAUDE.md` | **每次改代码前**。只有规矩，没有故事 | ~4.7k |
...
| `docs/logo-sources.md` | 换账户图标时 | ~1k |
| `docs/审查报告-2026-09-04.md` | **归档，别整本读**。71 条发现已全部处理完，结论并进了上面几份 | ~145k |

拆开是为了省 token：以前这些全在一个 19k 的 README 里，问一句细节就得整本读进来。
